# Isaac ROS TensorRT Benchmark - Intel Port

This folder contains a standalone Intel benchmark script for the TensorRT benchmark replacement:
- `isaac_ros_tensor_rt_intel.py`

On Intel, this benchmark uses the OpenVINO-based `DopeOpenVINONode` in place of the original TensorRT path.
...
```bash
cp /path/to/this/folder/isaac_ros_tensor_rt_intel.py \
  ~/ros2_ws/src/isaac_ros_benchmark/benchmarks/isaac_ros_tensor_rt_benchmark/scripts/
```
...
launch_test src/isaac_ros_benchmark/benchmarks/isaac_ros_tensor_rt_benchmark/scripts/isaac_ros_tensor_rt_intel.py
```
