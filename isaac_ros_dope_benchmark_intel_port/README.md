...
This folder contains a standalone Intel benchmark script for DOPE:
- `isaac_ros_dope_intel.py`

It follows the same tested workflow as AprilTag, CenterPose, DetectNet, and DNN Image Encoder.
...
### 1) Create workspace and clone benchmark sources
...
```bash
cp /path/to/this/folder/isaac_ros_dope_intel.py \
  ~/ros2_ws/src/isaac_ros_benchmark/benchmarks/isaac_ros_dope_benchmark/scripts/
```
