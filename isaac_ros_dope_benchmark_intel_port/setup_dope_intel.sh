...
cp "$SCRIPT_DIR/isaac_ros_dope_intel.py" "$WS/src/isaac_ros_benchmark/benchmarks/isaac_ros_dope_benchmark/scripts/"
...
cp "$SCRIPT_DIR/plugin_scaffold/dope_openvino_node.hpp" "$WS/src/isaac_ros_benchmark/isaac_ros_benchmark/include/isaac_ros_benchmark/"
cp "$SCRIPT_DIR/plugin_scaffold/dope_openvino_node.cpp" "$WS/src/isaac_ros_benchmark/isaac_ros_benchmark/src/"
