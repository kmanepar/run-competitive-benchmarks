...
This folder contains a standalone Intel benchmark script for RT-DETR:
- `isaac_ros_rtdetr_intel.py`

## Requirements
- ROS 2 Jazzy
- `ros2_benchmark`
- `image_proc`
- Intel-ported `isaac_ros_benchmark` source containing `RtDetrOpenVINONode`
- Model: `src/ros2_benchmark/assets/models/sdetr/sdetr_grasp.xml`
...
```bash
cp /path/to/this/folder/isaac_ros_rtdetr_intel.py \
  ~/ros2_ws/src/isaac_ros_benchmark/benchmarks/isaac_ros_rtdetr_benchmark/scripts/
```
...
python3 scripts/create_rtdetr_model.py
```
