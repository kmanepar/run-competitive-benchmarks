...
This folder contains a standalone Intel benchmark script for SegFormer:
- `isaac_ros_segformer_intel.py`

## Requirements
- ROS 2 Jazzy
- `ros2_benchmark`
- `image_proc`
- Intel-ported `isaac_ros_benchmark` source containing `SegmentationOpenVINONode`
- Model: `src/ros2_benchmark/assets/models/peoplesemsegformer/peoplesemsegformer.xml`
...
```bash
cp /path/to/this/folder/isaac_ros_segformer_intel.py \
  ~/ros2_ws/src/isaac_ros_benchmark/benchmarks/isaac_ros_segformer_benchmark/scripts/
```
...
python3 scripts/create_segformer_model.py
```
